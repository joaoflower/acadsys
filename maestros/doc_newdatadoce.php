		...
		<td align="center">
			<table border="0" cellpadding="0" cellspacing="1" bordercolor="#FF0000" class="tviewdata">
			  <tr>
				...
				<th width="150"><input name="rCod_prfn" type="text" class="" id="rCod_prfn" value="<?=$aEstudia['cod_prf']?>" size="4" maxlength="6" /></th>
				<td width="75">&nbsp;</td>
				<th width="150">&nbsp;</th>
			  </tr>
			  <tr>
...
<input name="rNombresn" type="text" class="" id="rNombresn" value="<?=$aEstudia['nombres']?>" size="20" maxlength="35" onBlur="fupper(this);" /></th>
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td>
			<div class="dboton"><a href="" onClick = "doc_savenewdatadoce(document.fData); return false;" class="isave" title="Modificar Datos">Guardar</a></div>
			<div class="dboton"><a href="" onClick="clearlayer('ddatos'); return false;" class="icancel" title="Cancelar">Cancelar</a></div>			
		</td>
	  </tr>
	</table>
<?
