...
<?
	...
	if(fsafetysetcaranoper())
	{
		...
		$_SESSION['sEstuNum_mat'] = $_POST['rNum_mat'];
		$_SESSION['sEstuCod_car'] = $_SESSION['sFrameCod_car'];		
		
		$vQuery = "insert into estudiante (num_mat, cod_car, paterno, materno, nombres, tip_doc, num_doc, fch_nac, sexo, est_civ, ";
		$vQuery .= "direc, fono, celular, email, con_est)  values ('{$_POST['rNum_mat']}', '{$_SESSION['sFrameCod_car']}', ";
		...
		$vQuery .= "'{$_POST['rDirec']}', '{$_POST['rFono']}', '{$_POST['rCelular']}', '{$_POST['rEmail']}', '1' )";
