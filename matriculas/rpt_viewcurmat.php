		...
		<td align="center">
			<table border="0" cellpadding="0" cellspacing="0" class="tlistdata">
			  ...
			  <tr <?=ftrstyle($vCont)?>  onMouseOver="mouseover(this)" onMouseOut="mouseout(this)" id="rTr<?=$aResult['cod_cur']?>">
			    ...
			    <td <?=ftdstyle($vNum_rows, $vCont)?>><a href="" onclick="rpt_viewestucurmat('<?=$aResult['pln_est']?>', '<?=$aResult['cod_cur']?>', '<?=$aResult['sec_gru']?>', '<?=$aResult['mod_act']?>'); return false;" class="enlaceb"><img src="../images/browse.png" alt="Listar estudiantes" width="16" height="16" /></a></td>
			  </tr>
			  <?
					$vCont++;
			  	}
