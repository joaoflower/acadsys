...
?>
			<tr <?=ftrstyle($vCont)?>  onMouseOver="mouseover(this)" onMouseOut="mouseout(this)">
			  ...
			  <td width="16" <?=ftdstyle($vNum_rows, $vCont)?>><a href="" onClick="ing_getdatamatri('<?=$aEstudia['num_mat']?>', '<?=$aEstudia['cod_car']?>'); return false;" class="linkicon"><img src="../images/browse.png" alt="Mostrar informaci&oacute;n" width="16" height="16" /></a></td>
			</tr>
<? 
			$vCont++; 	
		} 
