...
<?
	...
	if($bDatos == TRUE)
	{
		$_SESSION['sMatriCrd_cur'] = $_POST['rCrd_cur'];
		$_SESSION['sMatriTot_crd'] = $_POST['rCrd_cur'];
?>
<center>
<form action="#" method="post" enctype="multipart/form-data" name="fData" id="fData">
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td>
			<div class="dboton"><a href="prn_fichamatri.php" class="ireport" title="Imprimir" target="fReport">Imprimir</a></div>
			<div class="dboton"><a href="" onClick = "click<?=$_POST['rTipo']?>(); return false;" class="inew" title="Nueva Matr&iacute;cula">Nueva Mat.</a></div>			
		</td>
	  </tr>
	</table>
</form>
