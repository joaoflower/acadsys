	...
	if(fsafetysetcaranoper())
	{
		class PDF extends FPDF
		{
			...
			function Subhnota()
			{
				...
				$this->Cell(70,5, "MODALIAD: {$_SESSION['sPrnAct_des']}", 0);
				$this->Ln();
			...
			{			
				...
				while($aResult = mysql_fetch_array($cResult))
				{
					...
					if($vCont > 10 && (($vCont-1) % 28 == 0))
						$vCont2 = 0;
					
					$this->Cell(3);
					$this->Cell(5,7.3, $vCont, 0, 0, 'C');
					$this->Cell(12,7.3, $aResult['num_mat'], 0, 0, 'C');
					$this->Cell(90,7.3, $aResult['nom_est'], 0, 0, 'L');
					$this->Ln();

					$vIncre = $vCont2 * 7.3;
					$this->Line(11, 73 + $vIncre, 200, 75 + $vIncre);
