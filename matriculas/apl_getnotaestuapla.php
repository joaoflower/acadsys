...
?>
		...
		<td align="center">
			<table border="0" cellpadding="0" cellspacing="0" class="tlistdata">
			  ...
			  <?
				...
				$vQuery .= "mm.mod_not, mm.mod_mat, cm.cod_car, cm.ano_aca, cm.per_aca, cm.pln_est, cm.cod_cur ";
	...
	<table border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td>
			<div class="dboton"><a href="" onClick = "apl_savenotaestuapla(document.fData); return false;" class="isave" title="Guardar Datos">Guardar</a></div>
			<div class="dboton"><a href="" onclick="apl_viewestuapla('<?=$_SESSION['sPrnPln_est']?>', '<?=$_SESSION['sPrnCod_cur']?>', '<?=$_SESSION['sPrnSec_gru']?>', '<?=$_SESSION['sPrnMod_act']?>'); return false;" class="icancel" title="Cancelar">Cancelar</a></div>			
		</td>
	  </tr>
	</table>
<?
