	...
	<table border="0" cellpadding="0" cellspacing="0" class="tventana">
	  ...
	  <tr>
		...
		<td align="center"><table border="0" cellspacing="0" cellpadding="0" class="tlistsearch">
			...
			<tr class="trpar">
			  <td>&nbsp;</td>
			  <td><input name="rNum_mat" type="text" class="" id="rNum_mat" value="" size="9" maxlength="11" onBlur="not_verisearch(this);"></td>
			  <td><input name="rPaterno" type="text" class="" id="rPaterno" value="" size="15" maxlength="25" onBlur="not_verisearch(this);"></td>
			  <td><input name="rMaterno" type="text" class="" id="rMaterno" value="" size="15" maxlength="25" onBlur="not_verisearch(this);"></td>
			  <td><input name="rNombres" type="text" class="" id="rNombres" value="" size="20" maxlength="35" onBlur="not_verisearch(this);"></td>
			  <td>&nbsp;</td>
			</tr>
