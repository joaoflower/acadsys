...
//				$this->Cell(20);
			...
			function Subhnota2()
			{
				...
				$this->Cell(14,4,'CÓDIGO', 1, 0, 'C');
				$this->Cell(75,4,'NOMBRE DE LA ASIGNATURA', 1, 0, 'C');
			...
			{			
				...
				$vCont = 1;
				$vSem_anu = "XX";
			  	$vQuery = "select cu.pln_est, cu.cod_cur, cu.nom_ofi, cu.crd_cur, cu.sem_anu, se.sem_des, cu.cod_cat ";
				...
				while($aResult = mysql_fetch_array($cResult))
				{
					...
					$this->Cell(14,5,"{$aResult['cod_cat']}", 1, 0, 'L');
					$this->Cell(75,5,"{$aResult['nom_ofi']}", 1, 0, 'L');
