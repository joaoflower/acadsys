				...
				<table width="770" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="tcontent">
				  <tr id="trcontent">
					...
					<td valign="top" id="tdsubcontent">
						<div id="dsubcontent">
							<center>
							  <strong>AcadSys&reg; - <?=$_SESSION['sFrameUniversity']?><br>
							  Sistema Acad&eacute;mico - AcadSys</strong> <br>
							  <br>
							  Este Sistema esta desarrollado para la Administraci&oacute;n<br>
							  acad&eacute;mica de la Universidad, considerando 
							las etapas de<br>
							Matr&iacute;culas, asignaci&oacute;n de carga, ingreso de notas y reportes. <br>							
							<br>
							Puno - 2015
							</center>
					  	</div>
